...
assert(/tutor\.js\?v=177/.test(basecampHtml) && /basecamp\.js\?v=177/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/theme\.css\?v=177/.test(weekHtml) && /week\.js\?v=177/.test(weekHtml) && /game\.js\?v=177/.test(weekHtml) && /telemetry\.js\?v=177/.test(weekHtml), "index should cache-bust css/js");
...
["index.html", "progress.html", "parent.html", "messages.html", "admin.html", "characters.html", "ask.html", "basecamp.html", "story.html", "egg.html", "refs.html", "help.html"].forEach((file) => {
  ...
  assert(/\?v=177/.test(html), file + " should cache-bust v=177");
...
["index.html", "progress.html", "parent.html", "messages.html", "admin.html", "characters.html", "ask.html", "basecamp.html", "story.html", "egg.html", "refs.html", "ptable.html", "help.html"].forEach((file) => {
  const html = fs.readFileSync(path.join(root, file), "utf8");
  assert(/js\/update\.js\?v=177/.test(html), file + " loads the live-build checker");
...
assert(/progress\.js\?v=177/.test(progressHtml) && /theme\.css\?v=177/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*177/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should be 177");
assert(/2026-09-09T09:30:00-05:00/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD modified is 2026-09-09T09:30:00-05:00");
