...
assert(/tutor\.js\?v=101/.test(basecampHtml) && /basecamp\.js\?v=101/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/theme\.css\?v=101/.test(weekHtml) && /week\.js\?v=101/.test(weekHtml) && /game\.js\?v=101/.test(weekHtml) && /telemetry\.js\?v=101/.test(weekHtml), "index should cache-bust css/js");
...
["index.html", "progress.html", "parent.html", "messages.html", "admin.html", "characters.html", "ask.html", "basecamp.html"].forEach((file) => {
  const html = fs.readFileSync(path.join(root, file), "utf8");
  assert(!/\?v=99\b/.test(html), file + " should not still cache-bust as v=99");
  assert(/\?v=101/.test(html), file + " should cache-bust v=101");
});
...
assert(/progress\.js\?v=101/.test(progressHtml) && /theme\.css\?v=101/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*99/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should bump two steps");
