...
assert(/tutor\.js\?v=92/.test(basecampHtml) && /basecamp\.js\?v=92/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/id="bc-intro-play"/.test(basecampHtml) && /Tap to play/.test(basecampHtml), "tap-to-play exists when autoplay is blocked");
...
assert(/theme\.css\?v=92/.test(weekHtml) && /week\.js\?v=92/.test(weekHtml) && /game\.js\?v=92/.test(weekHtml) && /telemetry\.js\?v=92/.test(weekHtml), "index should cache-bust css/js");
...
assert(/progress\.js\?v=92/.test(progressHtml) && /theme\.css\?v=92/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*90/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should bump two steps");
