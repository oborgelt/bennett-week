...
assert(/tutor\.js\?v=132/.test(basecampHtml) && /basecamp\.js\?v=132/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/theme\.css\?v=132/.test(weekHtml) && /week\.js\?v=132/.test(weekHtml) && /game\.js\?v=132/.test(weekHtml) && /telemetry\.js\?v=132/.test(weekHtml), "index should cache-bust css/js");
...
["index.html", "progress.html", "parent.html", "messages.html", "admin.html", "characters.html", "ask.html", "basecamp.html", "story.html", "egg.html", "refs.html"].forEach((file) => {
  const html = fs.readFileSync(path.join(root, file), "utf8");
  assert(!/\?v=131\b/.test(html), file + " should not still cache-bust as v=131");
  assert(/\?v=132/.test(html), file + " should cache-bust v=132");
...
assert(/progress\.js\?v=132/.test(progressHtml) && /theme\.css\?v=132/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*130/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should be 130");
