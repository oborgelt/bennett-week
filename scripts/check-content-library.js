...
assert(/tutor\.js\?v=90/.test(basecampHtml) && /basecamp\.js\?v=90/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/theme\.css\?v=90/.test(weekHtml) && /week\.js\?v=90/.test(weekHtml) && /game\.js\?v=90/.test(weekHtml) && /telemetry\.js\?v=90/.test(weekHtml), "index should cache-bust css/js");
...
assert(/progress\.js\?v=90/.test(progressHtml) && /theme\.css\?v=90/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*88/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should bump two steps");
