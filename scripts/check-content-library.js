...
assert(/tutor\.js\?v=125/.test(basecampHtml) && /basecamp\.js\?v=125/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/theme\.css\?v=125/.test(weekHtml) && /week\.js\?v=125/.test(weekHtml) && /game\.js\?v=125/.test(weekHtml) && /telemetry\.js\?v=125/.test(weekHtml), "index should cache-bust css/js");
...
["index.html", "progress.html", "parent.html", "messages.html", "admin.html", "characters.html", "ask.html", "basecamp.html", "story.html", "egg.html", "refs.html"].forEach((file) => {
  const html = fs.readFileSync(path.join(root, file), "utf8");
  assert(!/\?v=124\b/.test(html), file + " should not still cache-bust as v=124");
  assert(/\?v=125/.test(html), file + " should cache-bust v=125");
...
assert(/progress\.js\?v=125/.test(progressHtml) && /theme\.css\?v=125/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*123/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should be 123");
