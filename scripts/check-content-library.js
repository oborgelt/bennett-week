...
assert(/tutor\.js\?v=151/.test(basecampHtml) && /basecamp\.js\?v=151/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/theme\.css\?v=151/.test(weekHtml) && /week\.js\?v=151/.test(weekHtml) && /game\.js\?v=151/.test(weekHtml) && /telemetry\.js\?v=151/.test(weekHtml), "index should cache-bust css/js");
...
["index.html", "progress.html", "parent.html", "messages.html", "admin.html", "characters.html", "ask.html", "basecamp.html", "story.html", "egg.html", "refs.html"].forEach((file) => {
  const html = fs.readFileSync(path.join(root, file), "utf8");
  assert(!/\?v=150\b/.test(html), file + " should not still cache-bust as v=150");
  assert(/\?v=151/.test(html), file + " should cache-bust v=151");
...
assert(/progress\.js\?v=151/.test(progressHtml) && /theme\.css\?v=151/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*149/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should be 149");
assert(/2026-08-21T15:10:00-05:00/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD modified is 2026-08-21T15:10:00-05:00");
