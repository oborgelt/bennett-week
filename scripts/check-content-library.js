...
assert(/tutor\.js\?v=95/.test(basecampHtml) && /basecamp\.js\?v=95/.test(basecampHtml), "Base Camp should cache-bust tutor/basecamp");
...
assert(/theme\.css\?v=95/.test(weekHtml) && /week\.js\?v=95/.test(weekHtml) && /game\.js\?v=95/.test(weekHtml) && /telemetry\.js\?v=95/.test(weekHtml), "index should cache-bust css/js");
...
assert(/progress\.js\?v=95/.test(progressHtml) && /theme\.css\?v=95/.test(progressHtml), "Progress should cache-bust css/js");
...
assert(/build:\s*93/.test(fs.readFileSync(path.join(root, "js/build.js"), "utf8")), "BW_BUILD should bump two steps");
