...
["index.html", "progress.html", "parent.html", "messages.html", "admin.html", "characters.html", "ask.html", "basecamp.html", "story.html", "egg.html", "refs.html"].forEach((file) => {
  const html = fs.readFileSync(path.join(root, file), "utf8");
  assert(!/\?v=109\b/.test(html), file + " should not still cache-bust as v=109");
...
Game.addNote(Game.emptyFamily(), { from: "bennett", kind: "question", text: "what is due?", targetType: "work", targetId: "ban-w1" });
assert.strictEqual(Game.getBananas(), 3, "an Ask is one banana");
Game.addNote(Game.emptyFamily(), { from: "bennett", kind: "note", text: "started the outline", targetType: "work", targetId: "ban-w1" });
assert.strictEqual(Game.getBananas(), 4, "a Bennett note is one banana");
Game.addNote(Game.emptyFamily(), { from: "orin", kind: "reply", text: "look at the rubric" });
